...
procedure MMatrix2Grid(SG: TStringGrid; M: Matrix);
function  MGrid2Matrix(SG: TStringGrid) : Matrix;
function  MReadFromStringList(var SL : TStrings): Matrix;

// Adds to TS all the elements from matrix A, line by line
procedure MAddToStringList(const m : Matrix; var TS: TStrings; FormatString: string = '%.6g'; ItemSeparator: string = ' ');

function MEqual( const m1,m2 : Matrix ; AllowErr : double ) : boolean;
